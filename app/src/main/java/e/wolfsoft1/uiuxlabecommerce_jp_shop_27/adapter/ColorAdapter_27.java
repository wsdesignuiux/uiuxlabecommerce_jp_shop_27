...
public class ColorAdapter_27 extends RecyclerView.Adapter<ColorAdapter_27.MyColorHolder> {

    private final Context context;
    private final ArrayList<Color_Model_27> color_modelArrayList;
    private int position;

    public ColorAdapter_27(Context context, ArrayList<Color_Model_27> color_modelArrayList) {
    ...
    public MyColorHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_color_27, viewGroup, false);
